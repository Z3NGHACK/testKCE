...
export class GMYearUpdateComponent {
    ...
    constructor(
        public dialogRef: MatDialogRef<GMYearUpdateComponent>,
    ...
    onSubmit(): void {
      ...
      // const body = this.firstFormGroup.value;
        this._service.update(body , this._id).subscribe({
          next: res => {
