...
import { DataResponse, FormattedUser, Invoice, Student } from './dashboard.type';
import { GMDashbordService } from './dashboard.service';
import { MatDialog, MatDialogConfig } from '@angular/material/dialog';
import { BranchViewPaymentComponent } from '../branch/view/view-payment/view.component';
import { ViewDialogDetailComponent } from '../branch/view/dialog-detail/dialog-detail.component';

const moment = _moment;

@Component({
    selector: 'general-manager-dashboard',
    standalone: true,
    imports: [
        MatButtonModule,
        MatIconModule,
...
export class DashboardComponent {
    ...
    constructor(
        private _dashbordService: GMDashbordService,
