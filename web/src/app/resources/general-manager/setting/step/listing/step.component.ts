...
import { CreateStepComponent } from '../create/create.component';
import { UpdateStepComponent } from '../update/update.component';


@Component({
    selector: 'general-manager-setting-step',
    standalone: true,
    imports: [
        MatIconModule,
        MatTableModule,
...
export class SettingStepComponent {
    ...
    create(){
        ...
        const dialogRef = this._matDialog.open(CreateStepComponent, dialogConfig);
    ...
    update( item : any){
        ...
        const dialogRef = this._matDialog.open(UpdateStepComponent, dialogConfig);
