...
import { Year } from '../academic.type';
import { MatDialog, MatDialogConfig } from '@angular/material/dialog';
import { AddYearComponent } from '../create/create.component';


@Component({
    selector: 'principal-year',
    standalone: true,
    imports: [
        MatIconModule,
        MatTableModule,
...
export class YearComponent {
    ...
    view(item: Year ): void {
        this._router.navigateByUrl(`/principal/year/view/${item.id}`);
    }
    ...
    create(): void {
        ...
        const dialogRef = this._matDialog.open(AddYearComponent, dialogConfig);
