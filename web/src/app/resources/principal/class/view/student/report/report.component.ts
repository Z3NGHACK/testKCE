...
@Component({
    selector: 'principle-view-classroom-report-dialog',
    standalone: true,
...
export class PrincipleClassroomReportDialogComponent {
    ...
    constructor(
        public dialogRef: MatDialogRef<PrincipleClassroomReportDialogComponent>,
    ...
    listing() {
        this.loading = true;
        this._service
            .reportBymonth(this.data.class_id, this.data.user_id, {
    ...
    viewDetail(item,l_id): void {
        ...
        dialogConfig.data = { data: this.data, item: item ,l_id:l_id};
        ...
        const dialogRef = this._matDialog.open(
            PrincipleClassroomMonthlyReportComponent,
            dialogConfig
        );
