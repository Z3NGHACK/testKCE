...
import { TeacherScheduleDetailComponent } from './detail/detail.component';

@Component({
    selector: 'teacher-classroom-schedule',
    standalone: true,
    imports: [
        MatIconModule,
        MatIconButton,
...
export class TeacherClassRoomScheduleComponent {
    @Input() id: number;
    @Input() data: any;
    ...
    getSetup() {
        ...
        this.service.getSetup(this.id).subscribe((res: any) => {
