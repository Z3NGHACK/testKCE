...
import { ClassroomShift } from 'app/resources/principal/class/classroom.type';
import { GlobalConstants } from 'helper/shared/constants';
import { SharedTeacherService } from 'app/shared/teacher/teacher.service';
import { SharedShiftDetailComponent } from './subject-detail/subject-detail.component';

@Component({
    selector: 'shared-class-room-teaching',
    standalone: true,
    imports: [
        MatIconModule,
        MatIconButton,
...
export class SharedClassRoomTeachingComponent {
    ...
    viewDetail(data): void {
        ...
        dialogConfig.data =  {path : this.path , data: data };
        dialogConfig.position = { right: '0', top: '0' };
        dialogConfig.height = '100vh';
        dialogConfig.panelClass = 'side-dialog';
        dialogConfig.autoFocus = false;
    
        const dialogRef = this._matDialog.open(SharedShiftDetailComponent, dialogConfig);
